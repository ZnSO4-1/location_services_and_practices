...
RESULT_ROOT = BASE_DIR / "experiments"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Evaluate additional map-matching metrics for GIOW experiments.")
    parser.add_argument(
        "--dataset",
        choices=["giow_track_subset"],
        default="giow_track_subset",
        help="Select which GIOW experiment result directory to evaluate.",
    )
...
def main():
    args = parse_args()
    result_dir = RESULT_ROOT / args.dataset / "results"
